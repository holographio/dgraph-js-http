...
var getStreamText = function (stream) { return new Promise(function (resolve, reject) {
    var text = "";
    stream.on("error", reject);
    stream.on("data", function (chunk) { return text += chunk; });
    stream.on("close", function () { return resolve(text); });
}); };
...
var DgraphClientStub = (function () {
    ...
    DgraphClientStub.prototype.callAPI = function (path, config) {
        return __awaiter(this, void 0, void 0, function () {
            var url, response, json, responseText, _a, err, errors;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!response.body.pipe) return [3, 3];
                        return [4, getStreamText(response.body)];
                    case 2:
                        _a = _b.sent();
                        return [3, 5];
